<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.8.7.a91bbab.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.8.7.a91bbab' . $minify_or_not . '.js');
