...
<!-- .................................. -->
*/
class Setup_bidang_kerja_model extends CI_Model
{

    public $table = 'setup_bidang_kerja';
    public $id = 'id_setup_bidang_kerja';
    public $delete_at = 'delete_at_setup_bidang_kerja';
    public $order = 'ASC';
    ...
    function total_rows($q = NULL, $kondisi = NULL)
    {
        ...
        if ($kondisi != NULL) {
            ...
            $this->db->group_start(); // open bracket.
            $this->db->like('id_setup_bidang_kerja', $q);
            $this->db->or_like('nama_setup_bidang_kerja', $q);
            $this->db->or_like('nama_view_setup_bidang_kerja', $q);
            $this->db->group_end(); //close bracket
...
/* End of file Setup_bidang_kerja_model.php */
/* Location: ./application/models/Setup_bidang_kerja_model.php */
/* Please DO NOT modify this information : */
/* Generated by Hisyam 2020-10-02 15:56:17 */
