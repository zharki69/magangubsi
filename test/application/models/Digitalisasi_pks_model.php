...
<!-- .................................. -->
*/
class Digitalisasi_pks_model extends CI_Model
{

    public $table = 'digitalisasi_pks';
    public $id = 'id';
    ...
    function total_rows($q = NULL, $kondisi = NULL)
    {
        ...
        if ($kondisi != NULL) {
            ...
            $this->db->or_like('no_pks', $q);
            $this->db->or_like('no_dpbj', $q);
            $this->db->or_like('tanggal_pks', $q);
            $this->db->or_like('tempelate_dokumen', $q);
            $this->db->or_like('render_dokumen', $q);
            $this->db->or_like('nama_supplier', $q);
            $this->db->or_like('file_pks_upload', $q);
...
/* End of file Digitalisasi_pks_model.php */
/* Location: ./application/models/Digitalisasi_pks_model.php */
/* Please DO NOT modify this information : */
/* Generated by Hisyam 2021-06-11 02:13:52 */
