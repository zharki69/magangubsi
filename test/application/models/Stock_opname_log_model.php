...
<!-- .................................. -->
*/
class Stock_opname_log_model extends CI_Model
{

    public $table = 'stock_opname_log';
    public $id = 'id';
    ...
    function total_rows($q = NULL, $kondisi = NULL)
    {
        ...
        if ($kondisi != NULL) {
            ...
            $this->db->group_start(); // open bracket.
            $this->db->like('id', $q);
            $this->db->or_like('kode_stock', $q);
            $this->db->or_like('kategori_log', $q);
...
/* End of file Stock_opname_log_model.php */
/* Location: ./application/models/Stock_opname_log_model.php */
/* Please DO NOT modify this information : */
/* Generated by Hisyam 2021-06-29 23:00:51 */
