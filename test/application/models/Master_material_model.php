...
class Master_material_model extends CI_Model
{
    ...
    public $table = 'pmalp_master_material';
    public $id = 'id';
    ...
    function total_rows($q = NULL, $kondisi = NULL)
    {
        ...
        if ($kondisi != NULL) {
            ...
            $this->db->group_start(); // open bracket.
            $this->db->like('id', $q);
            $this->db->or_like('kode_material', $q);
            $this->db->or_like('material_kategori', $q);
            $this->db->or_like('material_kelompok', $q);
            $this->db->or_like('material_sub_kelompok', $q);
            $this->db->or_like('nama', $q);
            $this->db->or_like('satuan', $q);
            $this->db->or_like('deskripsi_material', $q);
            $this->db->or_like('stok_minimum', $q);
            $this->db->or_like('approve_1_timestamp', $q);
            $this->db->or_like('approve_1_by', $q);
            $this->db->or_like('approve_2_timestamp', $q);
            $this->db->or_like('approve_2_by', $q);
            $this->db->or_like('approve_status', $q);
...
/* End of file Master_material_model.php */
/* Location: ./application/models/Master_material_model.php */
/* Please DO NOT modify this information : */
/* Generated by Hisyam 2021-06-29 10:22:03 */
