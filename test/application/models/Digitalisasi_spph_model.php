...
<!-- .................................. -->
*/
class Digitalisasi_spph_model extends CI_Model
{

    public $table = 'digitalisasi_spph';
    public $id = 'id';
    ...
    function total_rows($q = NULL, $kondisi = NULL)
    {
        ...
        if ($kondisi != NULL) {
            ...
            $this->db->group_start(); // open bracket.
            $this->db->like('id', $q);
            $this->db->or_like('no_spph', $q);
            $this->db->or_like('uuid', $q);
            $this->db->or_like('no_dpbj', $q);
            $this->db->or_like('tanggal_spph', $q);
            $this->db->or_like('cp_supplier', $q);
            $this->db->or_like('nama_supplier', $q);
            $this->db->or_like('alamat_supplier', $q);
            $this->db->or_like('email_supplier', $q);
            $this->db->or_like('pic_spph', $q);
            $this->db->or_like('ttd_nama', $q);
            $this->db->or_like('ttd_image', $q);
            $this->db->or_like('ttd_timestamp', $q);
...
/* End of file Digitalisasi_spph_model.php */
/* Location: ./application/models/Digitalisasi_spph_model.php */
/* Please DO NOT modify this information : */
/* Generated by Hisyam 2021-05-27 00:57:09 */
