...
<!-- .................................. -->
*/
class Digitalisasi_lpp_model extends CI_Model
{

    public $table = 'digitalisasi_lpp';
    public $id = 'id';
    ...
    function total_rows($q = NULL, $kondisi = NULL)
    {
        ...
        if ($kondisi != NULL) {
            ...
            $this->db->or_like('tanggal_pengesahan', $q);
            $this->db->or_like('supplier_pemenang', $q);
            $this->db->or_like('ttd_manajer_nama', $q);
            $this->db->or_like('ttd_manajer_image', $q);
            $this->db->or_like('ttd_manajer_timestamp', $q);
            $this->db->or_like('ttd_kadiv_nama', $q);
            $this->db->or_like('ttd_kadiv_image', $q);
            $this->db->or_like('ttd_kadiv_timestamp', $q);
            $this->db->or_like('ttd_dirbisops_nama', $q);
            $this->db->or_like('ttd_dirbisops_image', $q);
            $this->db->or_like('ttd_dirbisops_timestamp', $q);
...
/* End of file Digitalisasi_lpp_model.php */
/* Location: ./application/models/Digitalisasi_lpp_model.php */
/* Please DO NOT modify this information : */
/* Generated by Hisyam 2021-06-04 07:26:37 */
