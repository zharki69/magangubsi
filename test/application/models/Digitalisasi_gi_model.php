...
<!-- .................................. -->
*/
class Digitalisasi_gi_model extends CI_Model
{

    public $table = 'digitalisasi_gi';
    public $id = 'id';
    ...
    function total_rows($q = NULL, $kondisi = NULL)
    {
        ...
        if ($kondisi != NULL) {
            ...
            $this->db->or_like('applied_by', $q);
            $this->db->or_like('applicant_id', $q);
            $this->db->or_like('applicant_tel', $q);
            ...
            $this->db->or_like('start_site', $q);
            $this->db->or_like('destination_wh', $q);
            $this->db->or_like('source_province', $q);
            $this->db->or_like('source_city', $q);
            $this->db->or_like('source_regional', $q);
            ...
            $this->db->or_like('source_address', $q);
            $this->db->or_like('destination_wh_address', $q);
            $this->db->or_like('penandatangan_nama', $q);
            $this->db->or_like('penandatangan_image', $q);
            $this->db->or_like('penandatangan_timestamp', $q);
            ...
            $this->db->or_like('delete_at_digitalisasi_gi', $q);
            $this->db->group_end(); //close bracket
...
/* End of file Digitalisasi_gi_model.php */
/* Location: ./application/models/Digitalisasi_gi_model.php */
/* Please DO NOT modify this information : */
/* Generated by Hisyam 2021-07-12 10:53:23 */
