...
<!-- .................................. -->
*/
class Digitalisasi_dpbj_model extends CI_Model
{

    public $table = 'digitalisasi_dpbj';
    public $id = 'id';
    public $delete_at = 'delete_at_digitalisasi_dpbj';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL, $kondisi = NULL)
    {
        ...
        if ($kondisi != NULL) {
            ...
            $this->db->or_like('yang_membuat', $q);
            $this->db->or_like('unit_kerja', $q);
            $this->db->or_like('kode_kegiatan', $q);
            $this->db->or_like('jumlah', $q);
            $this->db->or_like('termasuk_ppn', $q);
            $this->db->or_like('jumlah_ppn', $q);
            $this->db->or_like('yang_meminta_nama', $q);
            $this->db->or_like('yang_meminta_image', $q);
            $this->db->or_like('yang_meminta_timestamp', $q);
            $this->db->or_like('yang_menyetujui_nama', $q);
            $this->db->or_like('yang_menyetujui_image', $q);
            $this->db->or_like('yang_menyetujui_timestamp', $q);
            $this->db->or_like('file_tor', $q);
            ...
            $this->db->or_like('delete_at_digitalisasi_dpbj', $q);
            $this->db->group_end(); //close bracket
    ...
    // update data
    function update($id, $data, $primary_key = NULL)
    {
        if ($primary_key == NULL) {
            $this->db->where($this->id, $id);
        } else {
...
/* End of file Digitalisasi_dpbj_model.php */
/* Location: ./application/models/Digitalisasi_dpbj_model.php */
/* Please DO NOT modify this information : */
/* Generated by Hisyam 2021-05-04 11:36:43 */
